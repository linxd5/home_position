...
function load (){
    ...
    function calculateTwoFingersChange() {
     ...
     //    var scaleValue = 1;
        ...
        xMove = (xMoveFinger1 + xMoveFinger2) / 2 ; 
        yMove = (yMoveFinger1 + yMoveFinger2) / 2 ;
        ...
        groupShape.transform({scale: scaleValue, cx:rotationCX, cy: rotationCY}).transform({rotation:rotationValue, cx:rotationCX, cy:rotationCY});
        ...
        layer2_text4.transform({rotation:rotationText});
        layer2_text5.transform({rotation:rotationText});
        layer2_text6.transform({rotation:rotationText});
        layer2_text7.transform({rotation:rotationText});
        layer2_text8.transform({rotation:rotationText});
        layer2_text9.transform({rotation:rotationText});
        layer2_text10.transform({rotation:rotationText});
        layer2_text11.transform({rotation:rotationText});
